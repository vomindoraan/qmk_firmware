...
#define MOD_MASK_LCTRL           MOD_BIT(KC_LCTRL)
...
#define MOD_MASK_RGUI            MOD_BIT(KC_RGUI)

#define MOD_MASK_CTRL            (MOD_MASK_LCTRL  | MOD_MASK_RCTRL)
#define MOD_MASK_SHIFT           (MOD_MASK_LSHIFT | MOD_MASK_RSHIFT)
#define MOD_MASK_ALT             (MOD_MASK_LALT   | MOD_MASK_RALT)
#define MOD_MASK_GUI             (MOD_MASK_LGUI   | MOD_MASK_RGUI)
