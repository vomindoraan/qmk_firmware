 ...
 */
#define CLOSE_ENCOUNTERS_5_NOTE DEPRECATED(CLOSE_ENCOUNTERS_5_NOTE, )
#define DOE_A_DEER              DEPRECATED(DOE_A_DEER, )
#define IN_LIKE_FLINT           DEPRECATED(IN_LIKE_FLINT, )
#define IMPERIAL_MARCH          DEPRECATED(IMPERIAL_MARCH, )
#define BASKET_CASE             DEPRECATED(BASKET_CASE, )
#define COIN_SOUND              DEPRECATED(COIN_SOUND, )
#define ONE_UP_SOUND            DEPRECATED(ONE_UP_SOUND, )
#define SONIC_RING              DEPRECATED(SONIC_RING, )
#define ZELDA_PUZZLE            DEPRECATED(ZELDA_PUZZLE, )
#define ZELDA_TREASURE          DEPRECATED(ZELDA_TREASURE, )
#define OVERWATCH_THEME         DEPRECATED(OVERWATCH_THEME, )
#define MARIO_THEME             DEPRECATED(MARIO_THEME, )
#define MARIO_GAMEOVER          DEPRECATED(MARIO_GAMEOVER, )
#define MARIO_MUSHROOM          DEPRECATED(MARIO_MUSHROOM, )
#define E1M1_DOOM               DEPRECATED(E1M1_DOOM, )
#define DISNEY_SONG             DEPRECATED(DISNEY_SONG, )
#define NUMBER_ONE              DEPRECATED(NUMBER_ONE, )
#define CABBAGE_SONG            DEPRECATED(CABBAGE_SONG, )
#define OLD_SPICE               DEPRECATED(OLD_SPICE, )
#define VICTORY_FANFARE_SHORT   DEPRECATED(VICTORY_FANFARE_SHORT, )
#define ALL_STAR                DEPRECATED(ALL_STAR, )
#define RICK_ROLL               DEPRECATED(RICK_ROLL, )
#define FF_PRELUDE              DEPRECATED(FF_PRELUDE, )
#define TO_BOLDLY_GO            DEPRECATED(TO_BOLDLY_GO, )
#define KATAWARE_DOKI           DEPRECATED(KATAWARE_DOKI, )
#define MEGALOVANIA             DEPRECATED(MEGALOVANIA, )
#define MICHISHIRUBE            DEPRECATED(MICHISHIRUBE, )
#define LIEBESLEID              DEPRECATED(LIEBESLEID, )
#define MELODIES_OF_LIFE        DEPRECATED(MELODIES_OF_LIFE, )
#define EYES_ON_ME              DEPRECATED(EYES_ON_ME, )
#define SONG_OF_THE_ANCIENTS    DEPRECATED(SONG_OF_THE_ANCIENTS, )
#define NIER_AMUSEMENT_PARK     DEPRECATED(NIER_AMUSEMENT_PARK, )
#define COPIED_CITY             DEPRECATED(COPIED_CITY, )
#define VAGUE_HOPE_COLD_RAIN    DEPRECATED(VAGUE_HOPE_COLD_RAIN, )
#define KAINE_SALVATION         DEPRECATED(KAINE_SALVATION, )
#define WEIGHT_OF_THE_WORLD     DEPRECATED(WEIGHT_OF_THE_WORLD, )
#define ISABELLAS_LULLABY       DEPRECATED(ISABELLAS_LULLABY, )
#define TERRAS_THEME            DEPRECATED(TERRAS_THEME, )
#define RENAI_CIRCULATION       DEPRECATED(RENAI_CIRCULATION, )
#define PLATINUM_DISCO          DEPRECATED(PLATINUM_DISCO, )
#define LP_NUMB                 DEPRECATED(LP_NUMB, )
