 ...
 */
#define CLOSE_ENCOUNTERS_5_NOTE DEPRECATED_M(CLOSE_ENCOUNTERS_5_NOTE, )
#define DOE_A_DEER              DEPRECATED_M(DOE_A_DEER, )
#define IN_LIKE_FLINT           DEPRECATED_M(IN_LIKE_FLINT, )
#define IMPERIAL_MARCH          DEPRECATED_M(IMPERIAL_MARCH, )
#define BASKET_CASE             DEPRECATED_M(BASKET_CASE, )
#define COIN_SOUND              DEPRECATED_M(COIN_SOUND, )
#define ONE_UP_SOUND            DEPRECATED_M(ONE_UP_SOUND, )
#define SONIC_RING              DEPRECATED_M(SONIC_RING, )
#define ZELDA_PUZZLE            DEPRECATED_M(ZELDA_PUZZLE, )
#define ZELDA_TREASURE          DEPRECATED_M(ZELDA_TREASURE, )
#define OVERWATCH_THEME         DEPRECATED_M(OVERWATCH_THEME, )
#define MARIO_THEME             DEPRECATED_M(MARIO_THEME, )
#define MARIO_GAMEOVER          DEPRECATED_M(MARIO_GAMEOVER, )
#define MARIO_MUSHROOM          DEPRECATED_M(MARIO_MUSHROOM, )
#define E1M1_DOOM               DEPRECATED_M(E1M1_DOOM, )
#define DISNEY_SONG             DEPRECATED_M(DISNEY_SONG, )
#define NUMBER_ONE              DEPRECATED_M(NUMBER_ONE, )
#define CABBAGE_SONG            DEPRECATED_M(CABBAGE_SONG, )
#define OLD_SPICE               DEPRECATED_M(OLD_SPICE, )
#define VICTORY_FANFARE_SHORT   DEPRECATED_M(VICTORY_FANFARE_SHORT, )
#define ALL_STAR                DEPRECATED_M(ALL_STAR, )
#define RICK_ROLL               DEPRECATED_M(RICK_ROLL, )
#define FF_PRELUDE              DEPRECATED_M(FF_PRELUDE, )
#define TO_BOLDLY_GO            DEPRECATED_M(TO_BOLDLY_GO, )
#define KATAWARE_DOKI           DEPRECATED_M(KATAWARE_DOKI, )
#define MEGALOVANIA             DEPRECATED_M(MEGALOVANIA, )
#define MICHISHIRUBE            DEPRECATED_M(MICHISHIRUBE, )
#define LIEBESLEID              DEPRECATED_M(LIEBESLEID, )
#define MELODIES_OF_LIFE        DEPRECATED_M(MELODIES_OF_LIFE, )
#define EYES_ON_ME              DEPRECATED_M(EYES_ON_ME, )
#define SONG_OF_THE_ANCIENTS    DEPRECATED_M(SONG_OF_THE_ANCIENTS, )
#define NIER_AMUSEMENT_PARK     DEPRECATED_M(NIER_AMUSEMENT_PARK, )
#define COPIED_CITY             DEPRECATED_M(COPIED_CITY, )
#define VAGUE_HOPE_COLD_RAIN    DEPRECATED_M(VAGUE_HOPE_COLD_RAIN, )
#define KAINE_SALVATION         DEPRECATED_M(KAINE_SALVATION, )
#define WEIGHT_OF_THE_WORLD     DEPRECATED_M(WEIGHT_OF_THE_WORLD, )
#define ISABELLAS_LULLABY       DEPRECATED_M(ISABELLAS_LULLABY, )
#define TERRAS_THEME            DEPRECATED_M(TERRAS_THEME, )
#define RENAI_CIRCULATION       DEPRECATED_M(RENAI_CIRCULATION, )
#define PLATINUM_DISCO          DEPRECATED_M(PLATINUM_DISCO, )
#define LP_NUMB                 DEPRECATED_M(LP_NUMB, )
