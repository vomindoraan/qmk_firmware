...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * ├───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┤
   * │FnC│ A │ S │ D │ F │ G │ H │ J │ K │ L │ ; │ ' │ \ │Ent│PgU│
   * ├───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┤
   * │LSf│RAl│ Z │ X │ C │ V │ B │ N │ M │ , │ . │ / │RSf│ ↑ │PgD│
   * ├───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┤
   * │LCt│LGu│LAl│Spc│Spc│Spc│Spc│Spc│Spc│AlG│FnL│RCt│ ← │ ↓ │ → │
   * └───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┘
   */
  [L_BASE] = LAYOUT_ortho_5x15( \
    ...
    FN_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_BSLS, KC_ENT,  KC_PGUP, \
    KC_LSFT, KC_RALT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_PGDN, \
    KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  KC_SPC,  KC_SPC,  KC_SPC,  KC_SPC,  KC_SPC,  RAL_RGU, FN_FNLK, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
   ...
   * ├───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┤
   * │M4 │M2 │M↑ │M1 │M3 │M5 │   │   │   │Stp│Ply│Prv│Nxt│Clr│Ins│
   * ├───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┤
   * │   │M← │M↓ │M→ │MW↑│   │   │   │   │   │   │   │   │   │Top│
   * ├───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┤
   * │   │   │   │MW←│MA2│MW→│   │   │   │VoD│VoU│Mut│   │PgU│Btm│
   * ├───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┤
   * │   │Dst│Dt←│MW↓│MW↓│MW↓│   │   │   │Dt→│   │App│Hom│PgD│End│
   * └───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┘
   */
  [L_FN] = LAYOUT_ortho_5x15( \
    ...
    _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_U, _______, _______, _______, _______, _______, _______, _______, _______, _______, TOP,     \
    _______, KC_ACL0, KC_ACL2, KC_WH_L, KC_WH_R, _______, _______, _______, _______, KC_VOLD, KC_VOLU, KC_MUTE, _______, KC_PGUP, BOTTOM,  \
    _______, DESKTOP, DSKTP_L, KC_WH_D, KC_WH_D, KC_WH_D, _______, _______, _______, DSKTP_R, _______, KC_APP,  KC_HOME, KC_PGDN, KC_END   \
  ),
  ...
  [L_NUMPAD] = LAYOUT_ortho_5x15( \
    ...
    _______, _______, _______, _______, _______, _______, _______, KC_P1,   KC_P2,   KC_P3,   KC_PAST, TIMES,   SQRT,    KC_PENT, _______, \
