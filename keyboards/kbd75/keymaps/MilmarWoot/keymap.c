...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL,  KC_LGUI,  KC_LALT,                      KC_SPC,   M_4SPC,   LCTLL,                        KC_RALT,  MO(2),    KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
	...
	[1] = LAYOUT(
		  ...
		  KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,              KC_NO,    KC_NO,
		  KC_NO,    KC_NO,    KC_NO,                        KC_NO,    KC_NO,    KC_NO,                        KC_NO,    MO(2),    KC_NO,   KC_NO,     KC_NO,    KC_NO
	),

	[2] = LAYOUT(
      RESET,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  TO(0),
    ...
    _______,  _______,  _______,                      _______,  _______,  _______,                      _______,  MO(1),    _______,  LGUILE,    LGUIDO,  LGUIRI
  ),
