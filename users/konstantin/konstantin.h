...
#define DST_NEW LCTL(LGUI(KC_D))
#define DST_CLS LCTL(LGUI(KC_F4))
#define DST_LFT LCTL(LGUI(KC_LEFT))
#define DST_RGT LCTL(LGUI(KC_RGHT))
#ifndef DST_SELECTOR_MODS
  #define DST_SELECTOR_MODS MOD_MASK_CTRL
#endif
